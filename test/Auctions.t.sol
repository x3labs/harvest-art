...
contract AuctionsTest is Test {
    ...
    function test_startAuctionERC721_Success() public {
        ...
        console.log("bidTicket balance of user before startAuction(): ", bidTicket.balanceOf(user1, 1));

        auctions.startAuctionERC721{value: 0.05 ether}(0.05 ether, address(mock721), tokenIds);
        console.log("bidTicket balance of user after startAuction(): ", bidTicket.balanceOf(user1, 1));
    }
